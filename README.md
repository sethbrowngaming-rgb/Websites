...
- `index.html` (repo root) — a redirect stub that forwards `/` to `/poflio/`. Once
...
- `ads.txt` (repo root) — AdSense publisher declaration (pub-3358856676053073). Stays
  ...
  as possible.
- `poflio/` — the personal portfolio site. `poflio/index.html` is a single-file
  ...
  https://sethbrowngaming-rgb.github.io/Websites/poflio/
...
Give each new project its own folder next to `poflio/` (same pattern: its own
